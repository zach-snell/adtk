...
<CardGrid>
  ...
  <Card title="Consolidated Tools" icon="puzzle">
    Rather than 75+ individual MCP tools, adtk groups related operations into 13 tools with an `action` parameter. This keeps the tool registry clean for AI agents.
  </Card>
