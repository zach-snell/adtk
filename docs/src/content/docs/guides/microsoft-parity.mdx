...
|---|---|---|
| **Total MCP tools** | 13 (consolidated) | ~75 (individual) |
| **Total actions** | 82 | ~75 |
...
Microsoft's MCP server has some capabilities not yet in adtk:
...
|---|---|---|
| Tool registration | 13 consolidated tools with `action` parameter | ~75 individual tool registrations |
